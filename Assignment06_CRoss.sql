...
-- 2022-02-20,CRoss,Created File
-- 2022-02-20,CRoss,Completed Script
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment06DB_CRoss')
	 Begin 
	  Alter Database [Assignment06DB_CRoss] set Single_user With Rollback Immediate;
	  Drop Database Assignment06DB_CRoss;
	 End
	Create Database Assignment06DB_CRoss;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment06DB_CRoss;
